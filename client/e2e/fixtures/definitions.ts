/**
 * Reusable machine definition fixtures for E2E tests.
 *
...
// Uses log-message as post-child action. The parent will end in error because
// MachineResult doesn't have the fields log-message needs, but we can still
// test the child spawning, waiting_for_child status, and child tree UI.
// ────────────────────────────────────────────────────────────────────────────
...
// Parent spawns two children in parallel. Like parent-child, the post-parallel
// action will error with built-in actions, but we can test spawning and tree UI.
// ────────────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────────────
// Definition for editor round-trip tests (created via UI, not API)
// ────────────────────────────────────────────────────────────────────────────

export const EDITOR_DEFINITION_META = {
  name: 'E2E Editor Test',
  description: 'Created via the definition editor',
};
